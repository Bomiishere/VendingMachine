...
class ViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    @IBAction func purchase() {
        if let currentSelection = currentSelection {
            do {
                ...
                showAlertWith(title: "Situation: Out of Stock", message: "Sorry. This item is unavailable. Please make another selection")
    ...
    @IBAction func updateQuantity(_ sender: UIStepper) {
        ...
        if let currentSelection = currentSelection, let item = vendingMachine.item(forSeclection: currentSelection) {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if let currentSelection = currentSelection, let item = vendingMachine.item(forSeclection: currentSelection) {
            let totoalPrice = item.price * quantityStepper.value
            updateDisplayWith(totalPrice: totoalPrice, itemPrice: item.price)
        }
    }
